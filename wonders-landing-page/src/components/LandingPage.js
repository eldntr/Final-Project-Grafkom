...
const wonders = [
    { name: 'Eiffel Tower - Paris (France)', path: '/models/eiffel_tower.glb', info: 'The Eiffel Tower, completed in 1889, was originally built as the entrance arch for the 1889 World\'s Fair held in Paris.\n' +
            ...
            'It takes 20,000 light bulbs to make the Eiffel Tower sparkle every evening, a spectacle admired by millions each year.' },
    ...
    {name: 'Christ the Redeemer - Rio de Janeiro (Brazil)', path: '/models/kristus.glb', info:'Christ the Redeemer in Rio de Janeiro stands 98 feet tall (30 meters), with an arm span stretching 92 feet, making it one of the largest Art Deco statues in the world.\n' +
            ...
            'In 2007, Christ the Redeemer was named one of the New Seven Wonders of the World, solidifying its status as a global icon of faith and culture.'},
    ...
    {name: 'Taj Mahal - Agra (India)', path: '/models/tajmahal.glb', info: 'The Taj changes its colour three times a day. The Taj Mahal seems pink in the morning and milky white in the evening and golden in the moonlight. In the centre of the Taj Mahal are the tombs of both Shah Jahan and Mumtaz Mahal.'},
    {name: 'Colloseum - Rome (Italy)', path: '/models/colloseum.glb', info: 'At its tallest point, the Colosseum stands 157 feet high. That\'s around the same height as the Washington Monument. There are four levels to the Colosseum and in ancient Rome, over 50,000 spectators could enter through the 80 entrances. When you\'re there, look for the diagonal break down the side of the amphitheater.'},
